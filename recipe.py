...
Milk
			Cost: $14.0 AUD	Cost per unit: $3.5 AUD

			Cost: $11.9 USD	Cost per unit: $2.98 USD

Bread
			Cost: $3.8 AUD	Cost per unit: $3.8 AUD

			Cost: $3.23 USD	Cost per unit: $3.23 USD

Butter
			Cost: $16.5 AUD	Cost per unit: $5.5 AUD

			Cost: $14.02 USD	Cost per unit: $4.68 USD

Eggs
			Cost: $7.5 AUD	Cost per unit: $7.5 AUD

			Cost: $6.38 USD	Cost per unit: $6.38 USD

Cheese
			Cost: $12.5 AUD	Cost per unit: $6.25 AUD

			Cost: $10.62 USD	Cost per unit: $5.31 USD

Raw Sugar
			Cost: $2.5 AUD	Cost per unit: $2.5 AUD

			Cost: $2.12 USD	Cost per unit: $2.12 USD

T-Bone Steak
			Cost: $66.0 AUD	Cost per unit: $16.5 AUD

			Cost: $56.1 USD	Cost per unit: $14.02 USD

Diced Beef
			Cost: $26.0 AUD	Cost per unit: $13.0 AUD

			Cost: $22.1 USD	Cost per unit: $11.05 USD

Madura Tea
			Cost: $25.0 AUD	Cost per unit: $6.25 AUD

			Cost: $21.25 USD	Cost per unit: $5.31 USD

Moccona Coffee
			Cost: $26.0 AUD	Cost per unit: $26.0 AUD

			Cost: $22.1 USD	Cost per unit: $22.1 USD
